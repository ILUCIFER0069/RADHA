// IndexedDB wrapper using idb library for browser usage
// This file provides a clean API for database operations
    ...
    async init() {
        try {
            ...
            if (typeof idb === 'undefined') {
                throw new Error('idb library not loaded. Please include the idb script before using this database.');
            }
